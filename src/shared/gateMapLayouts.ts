...
export const NEW_GATE_MAP_LAYOUTS: Record<NewGateMapId, GateMapLayout> = {
  ...
  kill_chambers: {
    ...
    walls: [
      ...
      { x: 450, y: 300, w: 50, h: 95 },
      { x: 450, y: 655, w: 50, h: 95 },
      { x: 900, y: 300, w: 50, h: 95 },
      { x: 900, y: 655, w: 50, h: 95 },
      // Tall east chamber, shifted down from the corner.
      { x: 2_100, y: 300, w: 50, h: 1_150 },
      { x: 2_700, y: 300, w: 50, h: 1_150 },
      { x: 2_150, y: 600, w: 125, h: 50 },
      { x: 2_575, y: 600, w: 125, h: 50 },
      { x: 2_150, y: 1_100, w: 125, h: 50 },
      { x: 2_575, y: 1_100, w: 125, h: 50 },
      // Wide south-west chamber.
      { x: 250, y: 1_950, w: 1_000, h: 50 },
      { x: 250, y: 2_550, w: 1_000, h: 50 },
      { x: 550, y: 2_000, w: 50, h: 125 },
      { x: 550, y: 2_425, w: 50, h: 125 },
      { x: 1_050, y: 2_000, w: 50, h: 125 },
      { x: 1_050, y: 2_425, w: 50, h: 125 },
      // Vertical inner chamber creates an offset fourth cell.
      { x: 1_450, y: 1_500, w: 50, h: 900 },
      { x: 2_000, y: 1_500, w: 50, h: 900 },
      { x: 1_500, y: 1_700, w: 105, h: 50 },
      { x: 1_895, y: 1_700, w: 105, h: 50 },
      { x: 1_500, y: 2_200, w: 105, h: 50 },
      { x: 1_895, y: 2_200, w: 105, h: 50 },
    ...
    gates: [
      { id: 'chamber-nw-entry', x: 450, y: 395, w: 50, h: 260, orientation: 'vertical', initialDelayMs: 0 },
      { id: 'chamber-nw-exit', x: 900, y: 395, w: 50, h: 260, orientation: 'vertical', initialDelayMs: 0 },
      { id: 'chamber-east-entry', x: 2_275, y: 600, w: 300, h: 50, orientation: 'horizontal', initialDelayMs: 2_200 },
      { id: 'chamber-east-exit', x: 2_275, y: 1_100, w: 300, h: 50, orientation: 'horizontal', initialDelayMs: 2_200 },
      { id: 'chamber-sw-entry', x: 550, y: 2_125, w: 50, h: 300, orientation: 'vertical', initialDelayMs: 4_400 },
      { id: 'chamber-sw-exit', x: 1_050, y: 2_125, w: 50, h: 300, orientation: 'vertical', initialDelayMs: 4_400 },
      { id: 'chamber-inner-entry', x: 1_605, y: 1_700, w: 290, h: 50, orientation: 'horizontal', initialDelayMs: 6_600 },
      { id: 'chamber-inner-exit', x: 1_605, y: 2_200, w: 290, h: 50, orientation: 'horizontal', initialDelayMs: 6_600 },
    ],
    spawners: [
      spawner(700, 500),
      spawner(2_420, 850),
